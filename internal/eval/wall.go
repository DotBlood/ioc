...
func WallRun(ctx context.Context, e *engine.Engine, spec *WallSpec, packetsW, goldW io.Writer, mode core.QueryMode, hierarchical, collapsed bool, coarseK int, rerank bool, graphBoost float64, graphSynonym float64) (*WallReport, error) {
	topK := spec.TopK
	if topK <= 0 {
		topK = 5
	}
